...
class Tweet {
  ...
  Map<String, dynamic> toMap() {
    ...
    result.addAll({'retweetsCount': retweetsCount});
  ...
  factory Tweet.fromMap(Map<String, dynamic> map) {
    return Tweet(
      ...
      id: map['\$id'] ?? '',
      retweetsCount: map['retweetsCount']?.toInt() ?? 0,
  ...
  @override
  String toString() {
    return 'Tweet(text: $text, hashtags: $hashtags, link: $link, imageLinks: $imageLinks, uid: $uid, tweetType: $tweetType, tweetedAt: $tweetedAt, likes: $likes, commentIds: $commentIds, id: $id, retweetsCount: $retweetsCount, retweetedBy: $retweetedBy, repliedTo: $repliedTo)';
  }
